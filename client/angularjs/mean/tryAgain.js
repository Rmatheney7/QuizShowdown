...
// angular.module('Questions').controller('QuestionsController', ['$scope', '$routeParams', '$location', 'Questions',
//     function ($scope, $routeParams, $location, Questions) {
...
//         var quizQuestion = new Questions({
